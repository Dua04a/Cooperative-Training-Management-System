...
/// </summary>
/// 
namespace maiyas10920WebApp.App_Code
{
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["maiyas10920ConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["maiyas10920ConStr"].ConnectionString);
        public CRUD()
        {
            //
