...
{
    public partial class Jumana_Login : System.Web.UI.Page
    {
            ...
            {
                // ضع هنا ما تريد فعله عند الضغط على زر "User"
                // مثلاً إعادة التوجيه إلى صفحة تسجيل المستخدم:
                Response.Redirect("UserRegistration.aspx");
            }

            protected void btnAdminRegister_Click(object sender, EventArgs e)
            {
                // ضع هنا ما تريد فعله عند الضغط على زر "Admin"
                // مثلاً إعادة التوجيه إلى صفحة تسجيل المدير:
            ...
            private void SetLanguage(string lang)
            {
                ...
                aboutLink.Text = dict["WhoWeAre"];
                healthCentersLink.Text = (lang == "ar") ? "المراكز الصحية" : "Health Centers";
                traineeRegLink.Text = (lang == "ar") ? "تسجيل المتدربين" : "Trainee Registration";
                clearanceFormLink.Text = (lang == "ar") ? "نموذج الإخلاء" : "Clearance Form";




                _ = (lang == "ar") ? arabicTexts : englishTexts;
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {{
        ...
        document.getElementById('linkContact').innerText = '{dict["Contact"]}';
            ...
            {
                Response.Redirect("RegisterNewAccount.aspx"); // غيّر الرابط إذا عندك صفحة ثانية
            }
            ...
            protected void btnLogin_Click(object sender, EventArgs e)
            {
                ...
                string connString = ConfigurationManager.ConnectionStrings["jumana11167ConStr"].ConnectionString;
                using (SqlConnection con = new SqlConnection(connString))
                {
                    string sql = "SELECT Department FROM Admin WHERE Username = @user AND Passwordd = @pass";
                    ...
                    if (dept != null)
                    {
                        ...
                        Session["Department"] = dept.ToString();
                        Session["Language"] = "ar"; // أو "en"
